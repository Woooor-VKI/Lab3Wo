...
{
    class GettingTriangle
    {
        //float[] first;
        //float[] second;
        //float[] third;
        //string type;
        public static (string, float[], float[], float[],string) GetTriangle(string a_Parameter, string b_Parameter, string c_Parameter)
        {
            try
            {
                ...
                {
                    return ("не треугольник", null, null, null, null);
                }
